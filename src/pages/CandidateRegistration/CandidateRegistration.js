...
const CandidateRegistration = () => {
  ...
  let handleEducationDetailsAddButtonError = (index) => {
    ...
    if (tempsEducationDetails[index].level === "") {
    ...
    if (tempsEducationDetails[index].instituteName === "") {
      ...
      tempErr[index].instituteName =
        "Enter valid institute name (Max 20 characters)";
    } else {
      tempErr[index].instituteName = "";
    }
    if (tempsEducationDetails[index].percentage === "") {
      ...
      tempsEducationDetails[index].percentage !== "" &&
      (tempsEducationDetails[index].percentage < 0 ||
        tempsEducationDetails[index].percentage > 100)
    ) {
    ...
    if (tempsEducationDetails[index].yop === "") {
      tempErr[index].yop = "This field is requried";
    } else if (
      tempsEducationDetails[index].yop !== "" &&
      (parseInt(tempsEducationDetails[index].yop) < 2000 ||
        parseInt(tempsEducationDetails[index].yop) > new Date().getFullYear())
    ) {
  ...
  const handleEducationDetailsError = (data) => {
    ...
    data.map((value, index) => {
      ...
      if (value.yop === "") {
        ...
        value.yop !== "" &&
        (parseInt(value.yop) < 2000 ||
          parseInt(value.yop) > new Date().getFullYear())
      ) {
        err = true;
        tempErr[index].yop = "Enter valid year of passout";
      } else {
